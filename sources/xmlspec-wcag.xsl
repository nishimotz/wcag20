...
-->
  ...
  <xsl:template match="header">
   ...
   <xsl:apply-templates select="trdisclaimer"/>
    <p align="center">[<a href="#contents">目次</a>]<xsl:text> </xsl:text>
    </p>
    <div class="head">
        ...
        <html>
          ...
          <body>
            ...
            <!-- BBC a plain old apply-templates item here will put things back the way they're supposed to be... 
              ...
              <div class="toc">
              <hr/><h2><a id="contents" name="contents"> </a>目次</h2><ul class="toc"><li><a href="#conformance">Conformance</a>
              <ul class="toc">
